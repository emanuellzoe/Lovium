  ...
  return (
    <div className="py-[120px]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-[60px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[60px] items-center mt-[60px]">
          {/* Diamond Visual */}
          <motion.div
          ...
          >
            <div className="absolute w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(192,57,43,0.3),transparent)] rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-[pulse_3s_ease-in-out_infinite]" />
            <span className="text-[120px] block animate-[diamondFloat_4s_ease-in-out_infinite] drop-shadow-[0_0_40px_rgba(192,57,43,0.5)]">
              💎
            </span>
            <div className="mt-5">
              <div className="font-serif text-[32px] font-bold">Diamond</div>
          ...
          >
            <h3 className="font-serif text-[28px] font-semibold mb-2">
              Pakai Diamond untuk:
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              {GIFTS.map((gift, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-3.5 px-[18px] bg-dark-card border border-white/5 rounded-xl transition-all duration-300"
                >
